...
The function should not modify the array. It should return the new array.jdh
*/
...
/*
Write a function filterRangeInPlace(arr, a, b) that gets an array arr and removes from 
it all values except those that are between a and b. The test is: a ≤ arr[i] ≤ b.
 ...
 */
  ...
  describe("getAverageAge", function() {
    ...
    it("creates an object grouped by id", function() {
      ...
      assert.deepEqual(getAverageAge(arr),20)
